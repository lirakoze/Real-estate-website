...
<!--	Title
    =========================================================-->
<title>Harshal Real Estate</title>
</head>
<body>
...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12"><!-- FOR MORE PROJECTS visit: freeprojectscodes.com -->
        ...
        <div class="full-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12"><!-- FOR MORE PROJECTS visit: freeprojectscodes.com -->
                            ...
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
                                    ...
                                    while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: freeprojectscodes.com -->
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            <div class="row">
                <?php
                $popularCitiesQuery = mysqli_query($con, "SELECT COUNT(city) AS city_count, city FROM property GROUP BY city ORDER BY city_count DESC LIMIT 8");
                while ($cityRow = mysqli_fetch_array($popularCitiesQuery)) {
                    $city = $cityRow['city'];
                    $cityCount = $cityRow['city_count'];

                    $stateQuery = mysqli_query($con, "SELECT COUNT(state) AS state_count, state FROM property WHERE city='$city' GROUP BY state");
                    while ($stateRow = mysqli_fetch_array($stateQuery)) {
                        $state = $stateRow['state'];
                        $totalProperties = $stateRow['state_count'];
                        $thumbnailIndex = rand(1, 4);
                        ?>
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9">
                                <img src="images/thumbnail4/<?php echo $thumbnailIndex; ?>.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <h4 class="hover-text-success text-capitalize">
                                        <a href="cityproperty.php?city=<?php echo urlencode($city); ?>">
                                            <?php echo $city; ?>
                                        </a>
                                    </h4>
                                    <span><?php echo $cityCount; ?> Properties Listed</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9">
                                ...
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <h4 class="hover-text-success text-capitalize">
                                        <a href="stateproperty.php?id=<?php echo $stateRow['state']; ?>">
                                            <?php echo $state; ?>
                                        </a>
                                    </h4>
                                    <span><?php echo $totalProperties; ?> Properties Listed</span>
                                </div>
                            </div>
                        </div>
                <?php
